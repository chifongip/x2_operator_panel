    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="Raw rectified front-center image for the operator panel.",
            ),
            DeclareLaunchArgument(
                "throttled_camera_topic",
                default_value="/x2/rgb_image_throttled",
                description="Raw throttled AprilTag input image for the operator panel.",
            ),
            DeclareLaunchArgument(
                ...
                parameters=[
                    {
                        ...
                        "camera_jpeg_quality": ParameterValue(
